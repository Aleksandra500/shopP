        ...
        <div className='mt-[50px] mx-[20px] lg:mx-[]'>
            ...
            <div className=' container mx-auto flex flex-col lg:flex-row gap-[20px]'>
                                ...
                                {cartData.map((product, index) => (
                                    ...
                                    >
                                        ...
                                        <TableCell align='right'>
                                            <button className=' text-red-400' onClick={() => handleRemoveProduct(product)}>
                                                Remove
                                            </button>
                                        </TableCell>
                                    </TableRow>
                ...
                <div className='w-full lg:w-[30%]'>
                    <h2 className='text-textWhite bg-orange-400 py-[17px] text-center rounded-md'>CART TOTAL</h2>
                    ...
                    <div className='flex flex-col gap-[20px]'>
                        ...
                        />
                        <span className='text-[13px] text-gray-300'>Insert copun for 50% discount</span>
                        <button
                            className={
                                activeCode === 'alphanedim'
                                    ? 'bg-gray-300 hover:bg-gray-500 text-black px-[15px] py-[7px] rounded-lg transition-all duration-300 cursor-pointer line-through'
                                    : 'bg-pink-500 hover:bg-orange-400 text-textWhite px-[15px] py-[7px] rounded-lg transition-all duration-300 cursor-pointer'
                            }
